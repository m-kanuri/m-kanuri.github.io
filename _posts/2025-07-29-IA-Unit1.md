...
<html lang="en">
  <style>
/* Page-scoped compact spacing */
.post-compact { font-size: 0.98rem; }
.post-compact h2,
.post-compact h3 { margin: .6rem 0 .35rem; line-height: 1.2; }
.post-compact p   { margin: .35rem 0; line-height: 1.45; }
.post-compact ul  { margin: .3rem 0 .5rem 1.2rem; }
.post-compact li  { margin: .2rem 0; }
.post-compact table { margin: .5rem 0; border-collapse: collapse; }
.post-compact td { padding: .25rem .5rem; vertical-align: top; }
.post-compact .button.large { padding: .4rem .7rem; font-size: .95rem; }
/* Optional: slightly reduce bottom gap that many themes add after headings */
.post-compact h2 + *,
.post-compact h3 + * { margin-top: .35rem !important; }
</style>
<body>
