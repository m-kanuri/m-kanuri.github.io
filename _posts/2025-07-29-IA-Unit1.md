...
<h3>**Outcome 1</h3>
<p style="text-align: justify;">Explored the key properties of intelligent agents — **autonomy**, **reactivity**, **proactiveness**, and **social ability** — and their roles in modern distributed systems.  
Gained understanding of how agents perceive and act within environments through **sensors** and **actuators**, and how these capabilities underpin **agent-based architectures** in real-world applications.</p>

<h3>**Outcome 2** </h3>
<p style="text-align: justify;"> Examined how the rise of agent-based systems has been driven by the demand for **scalable**, **flexible**, and **adaptive** solutions across **Industry 4.0**, **IoT**, and **multi-agent environments**.  
Reflected on how agents collaborate to achieve organisational goals through standard communication protocols such as **KQML** and **FIPA-ACL**.</p>p>

<h3>### **Outcome 3** </h3>
<p style="text-align: justify;"> Analysed case studies demonstrating the advantages of **decentralisation** and **self-organisation** in agent-based systems, particularly in achieving **robustness**, **efficiency**, and **responsiveness** compared to traditional monolithic architectures. </p>

<h3>### **Outcome 4**</h3
<p style="text-align: justify;">Debated the future of agent-based systems — considering whether the technology is in decline or evolving as a **core element within hybrid AI architectures**.  
Discussed the **philosophical and ethical dimensions** of autonomy and intelligence, emphasising **communication as a fundamental indicator of intelligent behaviour**.</p>p>
