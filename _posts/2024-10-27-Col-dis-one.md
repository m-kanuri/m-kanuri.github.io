...
<table>
    <tr>
      <td> <a href="artefacts/Colloborative Discussion-ML-Initial Post.pdf" target="_blank" class="button large">Initial Post</a></td> 
       <td> <a href="artefacts/Colloborative Discussion-ML-Initial Post.pdf" target="_blank" class="button large">Peer Responses</a></td> 
       <td> <a href="artefacts/Colloborative Discussion-ML-Initial Post.pdf" target="_blank" class="button large">Summary Post</a></td> 
    </tr>
</table>
