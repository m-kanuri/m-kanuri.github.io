...
<h4>Outcome 1</h4>
<p style="text-align: justify;">By creating a KQML and KIF dialogue between two agents, Alice and Bob, I learned how agents can communicate and share information using structured messages. This helped me understand why agent-based systems are useful for tasks like checking stock levels and product details in a warehouse environment.</p>
<h4>Outcome 2</h4>
<p style="text-align: justify;">Building this dialogue helped me see how agent models are linked to artificial intelligence concepts such as reasoning, cooperation, and knowledge sharing. I now understand how agents use formal languages like KQML and KIF to exchange information and make intelligent decisions together.</p>
<br>
